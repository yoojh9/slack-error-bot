package com.slack.logback.appender;
...
import com.slack.logback.config.LogConfig;
import com.slack.logback.entity.ErrorLog;
...
public class CustomerLogbackAppender extends UnsynchronizedAppenderBase<ILoggingEvent> {
	...
	public CustomerLogbackAppender() {
	
	}
	
	public CustomerLogbackAppender(LogConfig logConfig){
	...
	private void toSlack(ErrorLog errorLog) {
		...
		bodyInformation.setTitle("에러 Trace : ");
		bodyInformation.setValue(errorLog.getTrace());
		...
		System.out.println("slackAttachment ::: " + slackAttachment);
